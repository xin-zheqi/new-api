...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			// User subscription instance management.
		...
		lotteryAdminRoute.Use(middleware.AdminAuth())
		{
			...
			lotteryAdminRoute.GET("/:id/rounds", controller.AdminListLotteryRounds)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/usage/models", controller.GetTokenModelUsage)
		...
		apiRouter.GET("/group/status", middleware.HeaderNavModuleAuth("groupStatus"), controller.GetGroupStatus)
