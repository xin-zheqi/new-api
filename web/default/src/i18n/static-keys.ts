...
export const STATIC_I18N_KEYS = [
  ...
  'Unknown Model',
  'No usage data',
  'No model usage in selected range',
  'No API key usage found',
  'Adjust the time range or key filter.',
  ...
  // Support tickets (dynamic status and API error keys)
  'Needs reply',
  'Waiting for user',
  'Closed',
  '{{count}} messages',
  ...
  'Enter a valid ticket subject.',
  'Enter a valid ticket message.',
  'Image size must not exceed 5 MB.',
  'Invalid image file name.',
  'Only JPEG, PNG, and WebP images are supported.',
  'Image dimensions are invalid.',
  'Image processing is busy. Please try again.',
  'Ticket request failed. Please try again.',
